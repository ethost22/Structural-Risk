# Structural-Risk
Simulation of expected value (EV) versus expected growth rate (EGR) investment strategies; this work expands upon an earlier paper in decision theory (the "technical report" available in the repository), putting it in a computational context.
